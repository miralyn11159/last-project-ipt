        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content " id="modall">
                <div class="modal-header text-start">
                    <h5 class="modal-title title1 text-secondary" id="exampleModalLabel">Post something</h5>
                ...
                <div class="modal-footer">
                    <button type="button" id="submit-button" class="btn form-control" style="background-color: gray"
